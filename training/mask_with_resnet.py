...
ap.add_argument("-m", "--model", type=str,
	default="models/ResNet50_mask_detector.model",
...
# python detect_mask_image.py --image images/pic1.jpeg --model models/ResNet50_mask_detector.model

# cd training
# python training/mask_with_resnet.py --dataset "dataset" --model "ResNet50_mask_detector.model"
